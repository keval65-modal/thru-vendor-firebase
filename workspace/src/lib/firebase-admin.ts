...
try {
    // The key is stored as a single-line string in the .env file.
    // JSON.parse can handle it directly.
    ...
    throw new Error('Failed to parse the FIREBASE_ADMIN_SERVICE_ACCOUNT_KEY. Please ensure it is a valid, single-line JSON string in your .env.local file.');
}
